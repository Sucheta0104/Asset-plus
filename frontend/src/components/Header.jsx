    ...
    <>
      <header className="fixed top-0 left-0 w-full bg-white shadow-md z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
          ...
          <button 
            className="md:hidden flex flex-col justify-center items-center w-8 h-8 space-y-1 relative z-[60]"
            onClick={toggleMenu}
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="fixed top-[73px] left-0 w-full bg-white border-t shadow-lg z-50 md:hidden">
